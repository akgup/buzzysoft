	...
	<c:choose>
		<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE'}">
			<div class="container text-center">
				...
				<form class="form-horizontal" method="POST" action="create-claim" enctype="multipart/form-data"
								...
								<table class="table table-bordered table-hover" id="item_table">
									...
									<tbody>
										<tr id='addr0'>
											...
											<td><input type='file' name='upload_file' id='js-upload-files'></td>
										</tr>
										<tr id='addr1'></tr>
									</tbody>
								</table>
							...
							<tbody>
								<c:forEach var="claim" items="${claimList}">
									<tr>
										...
										<td><a href="/claim-attachment?claimid=${claim.claimId}"><span
