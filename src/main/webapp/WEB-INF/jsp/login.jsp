                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="txtUsername" type="text" value="${user.userName}"  class="form-control" name="userName" placeholder="Username" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="txtpasswd" type="password" value="${user.password}"  class="form-control" name="password" placeholder="Password" required />
                        </div>
                    </div>
